...
<div class="container login-container" style="margin-left:20%;" >
<div class="row"><h4><?php echo $msg?></h4></div>
            <div class="row">
                <div class="col-md-3 login-form-1" style="margin-left:10px;">
                    <h3>Student Login</h3>
                    <form action="login_server_page.php" method="get">
                        ...
                        <p>Don't have account please login here! <a href="signup.php">Signup</a></p>
                    </form>
                </div>
                ...
                <div class="col-md-3 login-form-1" style="margin-left:10px;">
                    <h3>Teacher Login</h3>
                    <form action="teacher_login_server.php" method="get">
                        <div class="form-group">
                            <input type="text" class="form-control" name="login_email" placeholder="Your Email *" value="" />
                        </div>
                        <Label style="color:red">*<?php echo $emailmsg?></label>
                        ...
                        <p>Don't have account please login here! <a href="teacherSignup.php">Signup</a></p>
                    </form>
                </div>

                <div class="col-md-3 login-form-2" style="margin-left:10px;">
                    <h3>Admin Login</h3>
